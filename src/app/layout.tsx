...
export const metadata: Metadata = {
  title: "Hookah Club - Premium Hookah Lounge Experience",
  description: "Experience the finest hookah traditions at Hookah Club. Premium tobacco selection, elegant atmosphere, exceptional service. Reserve your table today.",
  keywords: "hookah lounge, premium hookah, shisha bar, tobacco flavors, Middle Eastern culture, hookah experience, group events, private bookings",
  metadataBase: new URL("https://hookahclub.example.com"),
  alternates: {
    canonical: "https://hookahclub.example.com"
  },
  openGraph: {
    title: "Hookah Club - Premium Hookah Lounge Experience",
    description: "Experience the finest hookah traditions with premium tobacco selection, elegant atmosphere, and exceptional service.",
    siteName: "Hookah Club",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1763476681691-lj0mxbpd.jpg",
      alt: "Luxury hookah lounge interior"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Hookah Club - Premium Hookah Lounge Experience",
    description: "Experience the finest hookah traditions with premium tobacco selection and elegant atmosphere.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1763476681691-lj0mxbpd.jpg"]
  },
  robots: {
    index: true,
    follow: true
